...
https://azure.microsoft.com/en-us/blog/announcing-azure-container-instances/[Azure Container Instances (ACI)] are serverless containers on Azure.  The https://github.com/Azure/aci-connector-k8s[ACI connector] enables Kubernetes clusters to make use of ACI.

To setup ACI run:

 git clone git@github.com:Azure/aci-connector-k8s.git
 cd aci-connector-k8s
 kubectl apply -f examples/example-aci-connector.yaml
