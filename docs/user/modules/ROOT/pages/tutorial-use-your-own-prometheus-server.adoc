...
In this tutorial, we're going to use a Docker instance of Prometheus to build our consumer. Make sure that you have Docker installed and running on your machine. You should also have an available Couchbase cluster with at least one running node.

NOTE: The cluster must be configured for Analytics
