...
Note: We support BottleRocket OS for EKS workloads. To create EKS cluster with BottleRocket OS follow the steps https://kubernetes.io/docs/concepts/storage/storage-classes/#aws-ebs[here^].
