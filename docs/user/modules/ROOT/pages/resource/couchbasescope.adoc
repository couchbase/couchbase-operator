...
<<couchbasescopes-status,status>>:
  <<couchbasescopes-status-conditions,conditions>>:
  - <<couchbasescopes-status-conditions-lasttransitiontime,lastTransitionTime>>: ""
    <<couchbasescopes-status-conditions-message,message>>: ""
    <<couchbasescopes-status-conditions-observedgeneration,observedGeneration>>: 0
    <<couchbasescopes-status-conditions-reason,reason>>: ""
    <<couchbasescopes-status-conditions-status,status>>: ""
    <<couchbasescopes-status-conditions-type,type>>: ""
----
...
for a bucket.
When set to `true`, this allows the user to refer to and
manage collections within the default scope.
When not defined, the Operator
will implicitly manage the default scope as the default scope can not be
deleted from Couchbase Server.
The Operator defined default scope will
also have the `persistDefaultCollection` flag set to `true`.
Only one
...
=== couchbasescopes.status.conditions
...
=== couchbasescopes.status.conditions.lastTransitionTime
...
=== couchbasescopes.status.conditions.message
...
=== couchbasescopes.status.conditions.observedGeneration
...
=== couchbasescopes.status.conditions.reason
...
=== couchbasescopes.status.conditions.status
...
=== couchbasescopes.status.conditions.type
