...
<<couchbasemigrationreplications-status,status>>:
  <<couchbasemigrationreplications-status-conditions,conditions>>:
  - <<couchbasemigrationreplications-status-conditions-lasttransitiontime,lastTransitionTime>>: ""
    <<couchbasemigrationreplications-status-conditions-message,message>>: ""
    <<couchbasemigrationreplications-status-conditions-observedgeneration,observedGeneration>>: 0
    <<couchbasemigrationreplications-status-conditions-reason,reason>>: ""
    <<couchbasemigrationreplications-status-conditions-status,status>>: ""
    <<couchbasemigrationreplications-status-conditions-type,type>>: ""
----
...
== couchbasemigrationreplications.status
...
=== couchbasemigrationreplications.status.conditions
...
=== couchbasemigrationreplications.status.conditions.lastTransitionTime
...
=== couchbasemigrationreplications.status.conditions.message
...
=== couchbasemigrationreplications.status.conditions.observedGeneration
...
=== couchbasemigrationreplications.status.conditions.reason
...
=== couchbasemigrationreplications.status.conditions.status
...
=== couchbasemigrationreplications.status.conditions.type
