...
<<couchbasemigrationreplications-spec,spec>>:
  ...
  <<couchbasemigrationreplications-spec-colmappingrules,colMappingRules>>:
  <<couchbasemigrationreplications-spec-collectionsexplicitmapping,collectionsExplicitMapping>>: false
  <<couchbasemigrationreplications-spec-collectionsmigrationmode,collectionsMigrationMode>>: false
  ...
  <<couchbasemigrationreplications-spec-pauserequested,pauseRequested>>: false
...
=== couchbasemigrationreplications.spec.colMappingRules
...
=== couchbasemigrationreplications.spec.collectionsExplicitMapping
...
=== couchbasemigrationreplications.spec.collectionsMigrationMode
...
=== couchbasemigrationreplications.spec.pauseRequested
