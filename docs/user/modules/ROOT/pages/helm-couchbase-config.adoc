...
In particular, this page describes the contents of the chart's https://github.com/couchbase-partners/helm-charts/blob/{operator-version-branch}/charts/couchbase-operator/values.yaml[values.yaml^], which contains the chart's default values.
