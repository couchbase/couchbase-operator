...
# These files define the V1 Kubernetes API.
APISRC_V1 = pkg/apis/couchbase/v1/cluster.go \
	pkg/apis/couchbase/v1/cluster_tls.go \
	pkg/apis/couchbase/v1/doc.go \
	pkg/apis/couchbase/v1/status.go
...
API_PACKAGE_V1 = $(API_PACKAGE_BASE)/couchbase/v1
...
GENERATED_FILES = pkg/apis/couchbase/v1/zz_generated.deepcopy.go \
	pkg/apis/couchbase/v2/zz_generated.deepcopy.go \
...
pkg/generated/clientset: $(APISRC)
	@rm -rf $@
	go run k8s.io/code-generator/cmd/client-gen --clientset-name $(CLIENTSET_NAME) --input-base "" --input $(API_PACKAGE_V1),$(API_PACKAGE_V2) --output-package $(CLIENTSET_PACKAGE) $(CODEGEN_ARGS)

# Build the couchbase kubernetes listers when any API source changes.
pkg/generated/listers: $(APISRC)
	@rm -rf $@
	go run k8s.io/code-generator/cmd/lister-gen --input-dirs $(API_PACKAGE_V1),$(API_PACKAGE_V2) --output-package $(LISTERS_PACKAGE) $(CODEGEN_ARGS)
