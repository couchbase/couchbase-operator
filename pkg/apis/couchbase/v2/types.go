...
type EncryptionAtRestSpec struct {
	// Enabled is a boolean that enables the encryption at rest.
	Enabled bool `json:"enabled,omitempty"`
	...
	Configuration *EncryptionAtRestUsageConfiguration `json:"configuration,omitempty"`
...
type CouchbaseEncryptionKeyKMIP struct {
	...
	VerifyWithSystemCA bool `json:"verifyWithSystemCA,omitempty"`

	// VerifyWithCouchbaseCA defines whether to verify with Couchbase CA.
	VerifyWithCouchbaseCA bool `json:"verifyWithCouchbaseCA,omitempty"`
	...
	EncryptionApproach CouchbaseEncryptionApproach `json:"encryptionApproach"`
}
