...
type ClusterSpec struct {
	...
	// service class, with a minAvailable value of one less than the server class size. This allows for a more granular
	...
	// In order to enable this feature, the size of each serverClass must be at least 2 and the maximum number of Couchbase nodes
