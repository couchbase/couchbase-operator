...
func (c *Cluster) reconcileEncryptionKeys() error {
	...
	if err := c.createAndUpdateEncryptionKeys(requestedKeys, actualKeys, updateActualKeys); err != nil {
		return err
	}
...
func (c *Cluster) createAndUpdateEncryptionKeys(requestedKeys []*couchbasev2.CouchbaseEncryptionKey, actualKeys couchbaseutil.EncryptionKeyList, updateActualKeys func() error) error {
...
func (c *Cluster) convertEncryptionKey(key *couchbasev2.CouchbaseEncryptionKey, currentKeys *couchbaseutil.EncryptionKeyList, updateActualKeys func() error) (*couchbaseutil.EncryptionKey, error) {
	encryptionKey := &couchbaseutil.EncryptionKey{
		Name:  key.Name,
		Usage: c.getUsageList(key.GetUsage()),
	}
...
func (c *Cluster) getUsageList(usage couchbasev2.CouchbaseEncryptionKeyUsage) []string {
	...
	if usage.ManagedBucketSelection && !c.cluster.Spec.Buckets.Managed {
		// TODO: Find the buckets this encryption key is used in
		return usageList
	}
