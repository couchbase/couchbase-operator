...
var (
	...
	resources = []resource.Collector{
		...
		{Resource: &couchbasev2.CouchbaseScope{}, Scope: resource.ScopeAll},
		{Resource: &couchbasev2.CouchbaseScopeGroup{}, Scope: resource.ScopeAll},
		{Resource: &couchbasev2.CouchbaseCollection{}, Scope: resource.ScopeAll},
		{Resource: &couchbasev2.CouchbaseCollectionGroup{}, Scope: resource.ScopeAll},
