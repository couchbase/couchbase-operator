...
func (r *couchbaseUserResource) Fetch() error {
	couchbaseUsers, err := r.context.CouchbaseClient.CouchbaseV2().CouchbaseUsers(r.context.Namespace()).List(ctx.Background(), metav1.ListOptions{})
	if err != nil {
		return err
	}
...
func (r *couchbaseUserResource) References() []Reference {
	return []Reference{}
}
