...
type CouchbaseGroupInterface interface {
	...
	UpdateStatus(ctx context.Context, couchbaseGroup *v2.CouchbaseGroup, opts v1.UpdateOptions) (*v2.CouchbaseGroup, error)
...
func (c *couchbaseGroups) UpdateStatus(ctx context.Context, couchbaseGroup *v2.CouchbaseGroup, opts v1.UpdateOptions) (result *v2.CouchbaseGroup, err error) {
	result = &v2.CouchbaseGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("couchbasegroups").
