...
func TestNodeRecoveryAfterMemberAdd(t *testing.T) {
	...
	// * Depending on timing, the victim is killed either before it has active
	//   vBuckets (CBS reports FailedAdd) or after (CBS reports it as Down,
	//   with auto-failover kicking in ~30s later).
...
func TestNodeRecoveryKilledNewMember(t *testing.T) {
	...
	expectedEvents := []eventschema.Validatable{
		...
		eventschema.Optional{Validator: eventschema.Event{Reason: k8sutil.EventReasonMemberFailedOver, FuzzyMessage: victimName}},
		eventschema.Event{Reason: k8sutil.EventReasonNewMemberAdded},
		eventschema.Event{Reason: k8sutil.EventReasonRebalanceStarted},
...
func TestKillNodesAfterRebalanceAndFailover(t *testing.T) {
	...
	expectedEvents := []eventschema.Validatable{
		...
		eventschema.RepeatAtLeast{Times: 1,
			Validator: eventschema.Set{
		...
		eventschema.Optional{Validator: eventschema.Event{Reason: k8sutil.EventReasonMemberFailedOver, FuzzyMessage: victim1Name}},
		eventschema.Event{Reason: k8sutil.EventReasonNewMemberAdded, FuzzyMessage: victim2Name},
		eventschema.Optional{Validator: eventschema.RepeatAtLeast{Times: 1,
		...
		eventschema.Event{Reason: k8sutil.EventReasonNewMemberAdded},
		eventschema.Event{Reason: k8sutil.EventReasonRebalanceStarted},
		eventschema.Optional{Validator: eventschema.Event{Reason: k8sutil.EventReasonMemberRemoved, FuzzyMessage: victim1Name}},
		eventschema.Event{Reason: k8sutil.EventReasonRebalanceCompleted},
	}
