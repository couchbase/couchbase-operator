...
func GenerateWorkload(k8s *types.Cluster, couchbase *api.CouchbaseCluster, image, bucket string) (func(), error) {
...
func MustGenerateWorkload(t *testing.T, k8s *types.Cluster, couchbase *api.CouchbaseCluster, image, bucket string) func() {
