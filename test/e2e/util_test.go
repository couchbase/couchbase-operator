...
func registerTests() {
	framework.TestDefinitions = framework.TestDefList{
		...
		framework.NewTestDef(TestMandatoryMutualTLSWithMultipleCAsAndKubernetesSecrets).WithTags(TagSuiteP0, TagFeatureTLS),
		...
		framework.NewTestDef(TestMandatoryMutualTLSWithMultipleCAsAndRotateServerPKI).WithTags(TagSuiteP0, TagFeatureTLS),
		...
		framework.NewTestDef(TestMandatoryMutualTLSWithMultipleCAsAndRotateClientPKI).WithTags(TagSuiteP0, TagFeatureTLS),
		...
		framework.NewTestDef(TestXDCRReplicateLocalScopesAndCollections).WithTags(TagSuiteP0, TagFeatureXDCR, TagFeatureCollections),
