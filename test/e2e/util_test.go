...
func registerTests() {
	framework.TestDefinitions = framework.TestDefList{
		...
		framework.NewTestDef(TestPrometheusMetrics).WithTags(TagSuiteSanity, TagFeatureMetrics),
		...
		framework.NewTestDef(TestLoggingAndAuditingDefaults).WithTags(TagSuiteSanity, TagFeatureLogging),
		...
		framework.NewTestDef(TestTLSCreateClusterWithShadowing).WithTags(TagSuiteP0, TagFeatureTLS),
		...
		framework.NewTestDef(TestInflightLogRedaction).WithTags(TagSuiteP0, TagFeatureLogging),
		...
		framework.NewTestDef(TestOnlinePersistentVolumeResize).WithTags(TagSuiteP1, TagFeaturePersistentVolumes),
