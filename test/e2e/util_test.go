...
func registerTests() {
	framework.TestDefinitions = framework.TestDefList{
		...
		framework.NewTestDef(TestCouchbaseBucketStorageBackendDefault).WithTags(TagSuiteP0),
		framework.NewTestDef(TestCouchbaseBucketStorageBackendMagma).WithTags(TagSuiteP0),
		...
		framework.NewTestDef(TestMandatoryMutualTLSWithMultipleCAsAndKubernetesSecrets).WithTags(TagSuiteP0, TagFeatureTLS, TagSuitePlatform),
		framework.NewTestDef(TestMandatoryMutualTLSWithSingleSecretMultipleCAsAndKubernetesSecrets).WithTags(TagSuiteP0, TagFeatureTLS, TagSuitePlatform),
		framework.NewTestDef(TestMandatoryMutualTLSWithMultipleCAsAndCertManagerSecrets).WithTags(TagSuiteP0, TagFeatureTLS),
		framework.NewTestDef(TestMandatoryMutualTLSWithSingleSecretMultipleCAsAndCertManagerSecrets).WithTags(TagSuiteP0, TagFeatureTLS, TagSuitePlatform),
		...
		framework.NewTestDef(TestMandatoryMutualTLSWithMultipleCAsAndRotateServerPKI).WithTags(TagSuiteP0, TagFeatureTLS, TagSuitePlatform),
		framework.NewTestDef(TestMandatoryMutualTLSWithMultipleCAsAndRotateServerPKIWithOperatorDown).WithTags(TagSuiteP0, TagFeatureTLS),
		framework.NewTestDef(TestMandatoryMutualTLSWithMultipleCAsAndRotateClientPKI).WithTags(TagSuiteP0, TagFeatureTLS, TagSuitePlatform),
		framework.NewTestDef(TestMandatoryMutualTLSWithMultipleCAsAndRotateClientPKIWithOperatorDown).WithTags(TagSuiteP0, TagFeatureTLS),
		...
		framework.NewTestDef(TestClusterUpdateUsingScript).WithTags(TagSuiteP0, TagFeatureTLS),
		framework.NewTestDef(TestClusterUpdateUsingRest).WithTags(TagSuiteP1, TagFeatureTLS),
		...
		framework.NewTestDef(TestSyncGatewayCreateRemoteMandatoryMutualTLSWithMultipleCAs).WithTags(TagSuiteP0, TagFeatureTLS, TagFeatureSyncGateway),
		...
		framework.NewTestDef(TestBackupFullOnlyS3).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupFullOnlyAzure).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupFullOnlyGCP).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestore).WithTags(TagSuiteP0, TagFeatureBackup),
		framework.NewTestDef(TestBackupAndRestoreS3).WithTags(TagSuiteP0, TagSuitePlatform, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreAzure).WithTags(TagSuiteP0, TagSuitePlatform, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreGCP).WithTags(TagSuiteP0, TagSuitePlatform, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupFullIncrementalOverTLS).WithTags(TagSuiteP0, TagFeatureTLS),
		framework.NewTestDef(TestBackupFullIncrementalOverTLSS3).WithTags(TagSuiteP0, TagFeatureTLS, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupFullIncrementalOverTLSAzure).WithTags(TagSuiteP0, TagFeatureTLS, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupFullIncrementalOverTLSGCP).WithTags(TagSuiteP0, TagFeatureTLS, TagFeatureBackup, TagFeatureBackupCloud),
		...
		framework.NewTestDef(TestBackupFullOnlyOverTLSS3).WithTags(TagSuiteP0, TagFeatureTLS, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupFullOnlyOverTLSAzure).WithTags(TagSuiteP0, TagFeatureTLS, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupFullOnlyOverTLSGCP).WithTags(TagSuiteP0, TagFeatureTLS, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupFullOnlyOverTLSS3Standard).WithTags(TagSuiteP0, TagFeatureTLS, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupFullOnlyOverTLSAzureStandard).WithTags(TagSuiteP0, TagFeatureTLS, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupFullOnlyOverTLSGCPStandard).WithTags(TagSuiteP0, TagFeatureTLS, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestMultipleBackups).WithTags(TagSuiteP0, TagFeatureBackup, TagSuitePlatform),
		framework.NewTestDef(TestMultipleBackupsS3).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestMultipleBackupsAzure).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestMultipleBackupsGCP).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupRetention).WithTags(TagSuiteP0, TagFeatureBackup, TagSuitePlatform),
		framework.NewTestDef(TestBackupRetentionS3).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupRetentionAzure).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupRetentionGCP).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupPVCResize).WithTags(TagSuiteP0, TagFeatureBackup),
		framework.NewTestDef(TestBackupPVCResizeS3).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupPVCResizeGCP).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupPVCResizeAzure).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreDisableEventing).WithTags(TagSuiteP0, TagFeatureBackup),
		framework.NewTestDef(TestBackupAndRestoreDisableEventingS3).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreDisableEventingAzure).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreDisableEventingGCP).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreDisableGSI).WithTags(TagSuiteP0, TagFeatureBackup),
		framework.NewTestDef(TestBackupAndRestoreDisableGSIS3).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreDisableGSIAzure).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreDisableGSIGCP).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreDisableAnalytics).WithTags(TagSuiteP0, TagFeatureBackup),
		framework.NewTestDef(TestBackupAndRestoreDisableAnalyticsS3).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreDisableAnalyticsAzure).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreDisableAnalyticsGCP).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreDisableData).WithTags(TagSuiteP0, TagFeatureBackup),
		framework.NewTestDef(TestBackupAndRestoreDisableDataS3).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreDisableDataAzure).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreDisableDataGCP).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreEnableBucketConfig).WithTags(TagSuiteP0, TagFeatureBackup),
		framework.NewTestDef(TestBackupAndRestoreEnableBucketConfigS3).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreEnableBucketConfigAzure).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreEnableBucketConfigGCP).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreMapBuckets).WithTags(TagSuiteP0, TagFeatureBackup),
		framework.NewTestDef(TestBackupAndRestoreMapBucketsS3).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreMapBucketsAzure).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreMapBucketsGCP).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreIncludeBuckets).WithTags(TagSuiteP0, TagFeatureBackup),
		framework.NewTestDef(TestBackupAndRestoreIncludeBucketsS3).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreIncludeBucketsAzure).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreIncludeBucketsGCP).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreExcludeBuckets).WithTags(TagSuiteP0, TagFeatureBackup),
		framework.NewTestDef(TestBackupAndRestoreExcludeBucketsS3).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreExcludeBucketsAzure).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreExcludeBucketsGCP).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreNodeSelector).WithTags(TagSuiteP0, TagFeatureBackup),
		framework.NewTestDef(TestBackupAndRestoreNodeSelectorS3).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreNodeSelectorAzure).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreNodeSelectorGCP).WithTags(TagSuiteP0, TagFeatureBackup, TagFeatureBackupCloud),
		...
		framework.NewTestDef(TestPrometheusMetricsEnableMandatoryMutualShadowTLS).WithTags(TagSuiteP0, TagFeatureMetrics, TagFeatureTLS),
		...
		framework.NewTestDef(TestAutoscaleUpMandatoryMutualTLS).WithTags(TagSuiteP0, TagFeatureTLS, TagFeatureAutoScaling, TagSuitePlatform),
		...
		framework.NewTestDef(TestBackupAndRestoreCollectionsS3).WithTags(TagSuiteP0, TagFeatureCollections, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreCollectionsAzure).WithTags(TagSuiteP0, TagFeatureCollections, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreCollectionsGCP).WithTags(TagSuiteP0, TagFeatureCollections, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreScopesAndCollections).WithTags(TagSuiteP0, TagSuitePlatform, TagFeatureCollections),
		framework.NewTestDef(TestBackupAndRestoreScopesAndCollectionsS3).WithTags(TagSuiteP0, TagFeatureCollections, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreScopesAndCollectionsAzure).WithTags(TagSuiteP0, TagFeatureCollections, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreScopesAndCollectionsGCP).WithTags(TagSuiteP0, TagFeatureCollections, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreScope).WithTags(TagSuiteP0, TagFeatureCollections, TagFeatureBackup),
		framework.NewTestDef(TestBackupAndRestoreScopeS3).WithTags(TagSuiteP0, TagFeatureCollections, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreScopeAzure).WithTags(TagSuiteP0, TagFeatureCollections, TagFeatureBackup, TagFeatureBackupCloud),
		framework.NewTestDef(TestBackupAndRestoreScopeGCP).WithTags(TagSuiteP0, TagFeatureCollections, TagFeatureBackup, TagFeatureBackupCloud),
		...
		framework.NewTestDef(TestXDCRWithMandatoryTLSAndMultipleCAs).WithTags(TagSuiteP0, TagFeatureTLS, TagFeatureXDCR),
