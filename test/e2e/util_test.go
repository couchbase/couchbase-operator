...
func registerTests() {
	framework.TestDefinitions = framework.TestDefList{
		...
		framework.NewTestDef(TestMandatoryMutualTLSWithMultipleCAsAndKubernetesSecrets).WithTags(TagSuiteP0, TagSuitePlatform, TagFeatureTLS),
		framework.NewTestDef(TestMandatoryMutualTLSWithMultipleCAsAndCertManagerSecrets).WithTags(TagSuiteP0, TagSuitePlatform, TagFeatureTLS),
