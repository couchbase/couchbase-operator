...
func registerTests() {
	framework.TestDefinitions = framework.TestDefList{
		...
		framework.NewTestDef(TestValidationXDCRConflictLogging).WithTags(TagSuiteValidation, TagSuitePlatform),
		...
		framework.NewTestDef(TestCreateClusterWithoutTLSButTLSAnnotation).WithTags(TagSuiteSanity, TagSuitePlatform, TagFeatureTLS),
		...
		framework.NewTestDef(TestScaleDownAndRemoveServerGroupDeletesUnscheduledServerGroup).WithTags(TagSuiteSanity, TagFeatureServerGroups),
		...
		framework.NewTestDef(TestServerGroupOverrideSchedulesByCustomLabel).WithTags(TagSuiteSanity, TagFeatureServerGroups),
		framework.NewTestDef(TestServerGroupOverrideUpgradeIsInPlace).WithTags(TagSuiteSanity, TagFeatureServerGroups, TagFeaturePersistentVolumes, TagFeatureUpgrade),
		framework.NewTestDef(TestServerGroupOverrideClassZoneChangeSwaps).WithTags(TagSuiteSanity, TagFeatureServerGroups, TagFeaturePersistentVolumes),
		...
		framework.NewTestDef(TestInPlaceUpgradeIndexNodesWithSwapRebalanceOverrideAnyCandidate).WithTags(TagSuiteSanity, TagFeatureUpgrade),
		...
		framework.NewTestDef(TestXDCRStageCredentialRotation).WithTags(TagSuiteP0, TagFeatureXDCR),
		framework.NewTestDef(TestXDCRStageCredentialRotationTLS).WithTags(TagSuiteP0, TagSuitePlatform, TagFeatureTLS, TagFeatureXDCR),
		framework.NewTestDef(TestXDCRStageCredentialRotationThenUpdate).WithTags(TagSuiteP0, TagSuitePlatform, TagFeatureTLS, TagFeatureXDCR),
		...
		framework.NewTestDef(TestPodRecoveryMaxRetriesWithFailedNode).WithTags(TagSuiteP1, TagFeaturePersistentVolumes, TagFeatureRecovery),
		...
		framework.NewTestDef(TestServicesUpgradeOrderWithArbiterNodes).WithTags(TagSuiteP0, TagFeatureUpgrade),
		...
		framework.NewTestDef(TestPreviousVersionPodCountScaleUpWithServerClassesUpgradeOrder).WithTags(TagSuiteP0, TagFeatureUpgrade),
		...
		framework.NewTestDef(TestAlternateAddressExternalDNSCheckHoldsOutUnreachableNewPods).WithTags(TagSuiteP0, TagFeatureNetwork),
		framework.NewTestDef(TestAllowExternallyUnreachablePodsActivatesUnreachablePods).WithTags(TagSuiteP0, TagFeatureNetwork),
		framework.NewTestDef(TestExternalDNSDoesNotBlockRebalance).WithTags(TagSuiteP0, TagFeatureNetwork),
		...
		framework.NewTestDef(TestNetworkAddressFamilyChangeNodeToNodeControlPlaneOnly).WithTags(TagFeatureNetwork, TagFeatureTLS),
		framework.NewTestDef(TestNetworkAddressFamilyChangeNodeToNodeStrict).WithTags(TagFeatureNetwork, TagFeatureTLS),
		framework.NewTestDef(TestNetworkAddressFamilyChangeNodeToNodeAll).WithTags(TagFeatureNetwork, TagFeatureTLS),
		framework.NewTestDef(TestNetworkAddressFamilyChangeToOppositePriority).WithTags(TagFeatureNetwork, TagFeatureTLS),
		framework.NewTestDef(TestNetworkAddressFamilyChangeToOppositePriorityNodeToNodeControlPlaneOnly).WithTags(TagFeatureNetwork, TagFeatureTLS),
		framework.NewTestDef(TestNetworkAddressFamilyChangeToOppositePriorityNodeToNodeStrict).WithTags(TagFeatureNetwork, TagFeatureTLS),
		framework.NewTestDef(TestNetworkAddressFamilyChangeToOppositePriorityNodeToNodeAll).WithTags(TagFeatureNetwork, TagFeatureTLS),
		framework.NewTestDef(TestNetworkAddressFamilyAndNodeToNodeControlPlaneOnly).WithTags(TagFeatureNetwork, TagFeatureTLS),
		framework.NewTestDef(TestNetworkAddressFamilyAndNodeToNodeStrict).WithTags(TagFeatureNetwork, TagFeatureTLS),
		...
		framework.NewTestDef(TestCreateClusterWithTLSAndStrictNodeToNode).WithTags(TagSuiteP0, TagSuitePlatform, TagFeatureTLS),
		framework.NewTestDef(TestCreateClusterWithTLSAndStrictNodeToNodeThenScale).WithTags(TagSuiteP0, TagFeatureTLS),
		framework.NewTestDef(TestCreateClusterWithTLSAndStrictNodeToNodeThenKillPod).WithTags(TagSuiteP0, TagFeatureTLS),
		framework.NewTestDef(TestCreateClusterWithTLSThenEnableStrictNodeToNode).WithTags(TagSuiteP0, TagFeatureTLS),
		framework.NewTestDef(TestCreateClusterWithTLSAndStrictNodeToNodeThenDisableNodeToNode).WithTags(TagSuiteP0, TagFeatureTLS),
		framework.NewTestDef(TestCreateClusterWithTLSAndStrictNodeToNodeThenChangeToControlPlaneNodeToNode).WithTags(TagSuiteP0, TagFeatureTLS),
		framework.NewTestDef(TestCreateClusterWithTLSAndStrictNodeToNodeThenChangeToFullNodeToNode).WithTags(TagSuiteP0, TagFeatureTLS),
		framework.NewTestDef(TestCreateClusterWithTLSAndControlPlaneNodeToNodeThenChangeToStrictNodeToNode).WithTags(TagSuiteP0, TagFeatureTLS),
		framework.NewTestDef(TestCreateClusterWithTLSAndFullNodeToNodeThenChangeToStrictNodeToNode).WithTags(TagSuiteP0, TagFeatureTLS),
		framework.NewTestDef(TestCreateClusterWithTLSAndStrictNodeToNodeThenRotateServerCertificate).WithTags(TagSuiteP0, TagFeatureTLS),
		framework.NewTestDef(TestCreateClusterWithTLSAndStrictNodeToNodeAndRotateCA).WithTags(TagSuiteP0, TagFeatureTLS),
		framework.NewTestDef(TestCreateClusterThenEnableStrictNodeToNode).WithTags(TagSuiteP0, TagFeatureTLS),
		...
		framework.NewTestDef(TestMandatoryMutualTLSNodeClientCert).WithTags(TagSuiteP1, TagSuitePlatform, TagFeatureTLS),
		...
		framework.NewTestDef(TestBackupAndRestoreToSubPathS3).WithTags(TagSuiteP1, TagFeatureBackup),
		framework.NewTestDef(TestBackupAndRestoreEphemeralVolumeS3).WithTags(TagSuiteP1, TagFeatureBackup, TagFeatureBackupCloud),
		...
		framework.NewTestDef(TestBackupLogsCollection).WithTags(TagSuiteP1, TagFeatureBackup, TagFeatureSupportability),
		framework.NewTestDef(TestBackupLogsCollectionWithName).WithTags(TagSuiteP1, TagFeatureBackup, TagFeatureSupportability),
		framework.NewTestDef(TestBackupAndRestoreCleansUpOrphanedJobs).WithTags(TagSuiteP1, TagFeatureBackup, TagFeatureSupportability),
		...
		framework.NewTestDef(TestMirWatchdogRemovesConditionsMetricWhenDisabled).WithTags(TagSuiteP1, TagFeatureMir),

		// Encryption at rest tests
		framework.NewTestDef(TestEncryptionAtRest).WithTags(TagSuiteP1, TagFeatureEAR),
		framework.NewTestDef(TestAutoGeneratedEncryptionKey).WithTags(TagSuiteP1, TagFeatureEAR),
		framework.NewTestDef(TestCreateEncryptedBucket).WithTags(TagSuiteP1, TagFeatureEAR),
		framework.NewTestDef(TestCreateUseDeleteAutoGeneratedEncryptionKey).WithTags(TagSuiteP1, TagFeatureEAR),
		framework.NewTestDef(TestCreateUseWithBucketDeleteAutoGeneratedEncryptionKey).WithTags(TagSuiteP1, TagFeatureEAR),
		framework.NewTestDef(TestCreateEditAWSKey).WithTags(TagSuiteP1, TagFeatureEAR),
		framework.NewTestDef(TestCreateEditKMIPKey).WithTags(TagSuiteP1, TagFeatureEAR),
		...
		framework.NewTestDef(TestServerGroupAddNoRedistributeUnstable).WithTags(TagSuiteP1, TagFeatureServerGroups),
	}
}
