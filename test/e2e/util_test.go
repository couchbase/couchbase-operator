...
func registerTests() {
	framework.TestDefinitions = framework.TestDefList{
		...
		framework.NewTestDef(TestRescheduleCandidatesAlternateAddressExternalDNSCheck).WithTags(TagSuiteP0, TagFeatureUpgrade),
		framework.NewTestDef(TestRescheduleCandidatesAndScaleDownAlternateAddressExternalDNSCheck).WithTags(TagSuiteP0, TagFeatureUpgrade),
		framework.NewTestDef(TestRescheduleMultipleCandidatesAndScaleDownAlternateAddressExternalDNSCheck).WithTags(TagSuiteP0, TagFeatureUpgrade),
		framework.NewTestDef(TestRescheduleCandidatesAndScaleUpAlternateAddressExternalDNSCheck).WithTags(TagSuiteP0, TagFeatureUpgrade),
		...
		framework.NewTestDef(TestMandatoryMutualTLSNodeClientCertEnableToMandatory).WithTags(TagSuiteP1, TagSuitePlatform, TagFeatureTLS),
		framework.NewTestDef(TestMandatoryMutualTLSNodeClientCertPlainToMandatory).WithTags(TagSuiteP1, TagSuitePlatform, TagFeatureTLS),
