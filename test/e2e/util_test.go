...
var (
	TestFuncMap = framework.FuncMap{
		...
		"TestAutoscaleEnabledAllowsStatefulTLS": TestAutoscaleEnabledAllowsStatefulTLS,
		"TestAutoscaleVerifyMaintenanceMode":    TestAutoscaleVerifyMaintenanceMode,
		"TestAutoscaleManualMaintenanceMode":    TestAutoscaleManualMaintenanceMode,
		...
		"TestOnlinePersistentVolumeResizeWithDocs":      TestOnlinePersistentVolumeResizeWithDocs,
		"TestOnlinePersistentVolumeResizeWhenPodKilled": TestOnlinePersistentVolumeResizeWhenPodKilled,
