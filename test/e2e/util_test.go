...
func registerTests() {
	framework.TestDefinitions = framework.TestDefList{
		...
		framework.NewTestDef(TestBackupFullIncrementalS3).WithTags(TagSuiteSanity, TagFeatureBackup),
		...
		framework.NewTestDef(TestBackupRetentionS3).WithTags(TagSuiteP0, TagFeatureBackup),
		...
		framework.NewTestDef(TestBackupAndRestoreCollectionsS3).WithTags(TagSuiteP0, TagFeatureCollections, TagFeatureBackup),
		framework.NewTestDef(TestBackupAndRestoreScopesAndCollections).WithTags(TagSuiteP0, TagSuitePlatform, TagFeatureCollections, TagFeatureBackup),
		framework.NewTestDef(TestBackupAndRestoreScopesAndCollectionsS3).WithTags(TagSuiteP0, TagFeatureCollections, TagFeatureBackup),
