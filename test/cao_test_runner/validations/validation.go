...
import (
	...
	destroycrdvalidator "github.com/couchbase/couchbase-operator/test/cao_test_runner/validations/destroy/crd"
...
func RegisterValidators() map[string]Validator {
	return map[string]Validator{
		...
		"DestroyCRDValidator":               &destroycrdvalidator.DestroyCRDValidator{},
	}
}
