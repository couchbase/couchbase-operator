		...
		Commands: []*cbflag.Command{
			&cbflag.Command{
				...
				Flags: []*cbflag.Flag{
					...
					cbflag.BoolFlag(
						...
						/* Long Option  */ "dry-run",
						/* Env Variable */ "",
						/* Usage        */ "If specified, only print the object that would be sent, without sending it",
						/* Deprecated   */ []string{},
						/* Hidden       */ false,
					),
					cbflag.BoolFlag(
						/* Destination  */ &applyCtx.verifyVersion,
						/* Default      */ true,
						/* Short Option */ "",
						/* Long Option  */ "verify-version",
						/* Env Variable */ "",
						/* Usage        */ "If disabled, skips version checking of couchbase server",
						/* Deprecated   */ []string{},
						/* Hidden       */ false,
					),
					cbflag.StringFlag(
			...
			&cbflag.Command{
				...
				Flags: []*cbflag.Flag{
					...
					cbflag.BoolFlag(
						/* Destination  */ &createCtx.verifyVersion,
						/* Default      */ true,
						/* Short Option */ "",
						/* Long Option  */ "verify-version",
						/* Env Variable */ "",
